...
class Config(dict):
    ...
    def __setitem__(self, key: Any, value: Any) -> None:
        ...
        if key in ("langs_order", "lrc_ms_digit_count", "add_end_timestamp_line", "last_ref_line_time_sty", "lrc_tag_info_src"):
            if self.lyrics_changed is not None:
                self.lyrics_changed((key, value))
        elif key in (
            "desktop_lyrics_font_family",
            ...
            if self.desktop_lyrics_changed is not None:
                self.desktop_lyrics_changed((key, value))
